...
const path = 'apps/platform/client/src/modules/ale-bet/pages/PedidoDetailPage.tsx'
...
const endTag = \`      <CambiarClienteSheet\`
...
const newContent = content.slice(0, startIndex) + newRender + content.slice(endIndex + endTag.length)
